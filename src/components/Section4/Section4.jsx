...
const Section4 = () => {
  return (
    <div className="container mx-auto mt-[150px] flex flex-col md:flex-row justify-between items-start gap-[25px] sm:gap-auto">
      <FormEmail />

      <div className="flex flex-col sm:flex-row items-start justify-between md:justify-normal gap-[25px] sm:gap-5 w-full md:w-auto">
        <div className="w-[250px] shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] rounded-[20px] w-full sm:w-auto">
